...
public class LinkedListProblems {
    ...
    public static void main(String[] args) {
        ...
        l1.delete(3); //in-between the linked list
        l1.printLinkedList();
        l1.delete(0); //start of the linked list
        l1.printLinkedList();
        l1.delete(100); // case where the node to be deleted does not exist
        l1.printLinkedList();
        l1.delete(6); //delete the last node in the linked list
        l1.printLinkedList();
